...
public class Logger {
    ...
    public Logger(String name, boolean colorful) {
        this.name = name;
    ...
    public void info(String log) {
        ...
        System.out.println(colorful ? "\u001B[32m" + log + "\u001B[0m" : log);
    ...
    public void debug(String log) {
        ...
        System.out.println(colorful ? "\u001B[37m" + log + "\u001B[0m" : log);
        LoggerUtils.writelog(log, LoggerUtils.logfile.getAbsolutePath());
    }
    ...
    public void warn(String log) {
        ...
        System.out.println(colorful ? "\u001B[33m" + log + "\u001B[0m" : log);
        LoggerUtils.writelog(log, LoggerUtils.logfile.getAbsolutePath());
    }
    ...
    public void error(String log) {
        ...
        System.out.println(colorful ? "\u001B[31m" + log + "\u001B[0m" : log);
        LoggerUtils.writelog(log, LoggerUtils.logfile.getAbsolutePath());
    }
}
